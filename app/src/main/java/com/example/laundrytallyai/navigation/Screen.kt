...
sealed class Screen(val route: String, val icon: @Composable (() -> ImageVector)) {
    ...
    object ClothesCreate : Screen("clothesCreate", {ImageVector.vectorResource(R.drawable.t_shirt)})
    ...
    object LaundryCreate : Screen("create-laundry/{launderer_id}/{launderer_name}", {ImageVector.vectorResource(id = R.drawable.laundry_basket_24)})
    object LaundrySelectClothes : Screen("select-clothes", {ImageVector.vectorResource(id = R.drawable.laundry_basket_24)})
